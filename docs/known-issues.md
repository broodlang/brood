...
## KI-166 — a map's iteration order depends on how the prelude arrived 🔶 WATCH — the gate is fixed, the language question is open (2026-09-19)
