...
//!
//! The tuning knobs come first — the thresholds, strides and env overrides that decide
//! *when* the collector runs and how much it does — followed by the collector itself.
use super::*;
...
pub(super) fn gc_count_env(key: &str) -> Option<usize> {
...
pub(super) static LIVE_PROCESSES: AtomicUsize = AtomicUsize::new(0);
...
pub(super) fn rt_gc_floor() -> usize {
...
pub(super) const RT_DRAIN_SCAN_STRIDE: u32 = 64;
...
pub(super) const DRAIN_REPORT_STRIDE: u32 = 64;
...
pub(super) const P2_REVALIDATE_STRIDE: u32 = 64;
...
pub(super) const P1_REVALIDATE_STRIDE: u32 = 64;
...
pub(super) const P1_LARGE_SEED: usize = 4096;
...
pub(super) const NURSERY_MAX: usize = 8 * 1024 * 1024;
...
/// guarantee.
pub(super) const WALKER_RED_ZONE: usize = 64 * 1024;
...
pub(super) const WALKER_STACK_CHUNK: usize = 1024 * 1024;

pub(super) fn major_growth() -> usize {
...
pub(super) fn major_floor() -> usize {
    static FLOOR: std::sync::OnceLock<usize> = std::sync::OnceLock::new();
    *FLOOR.get_or_init(|| {
        if std::env::var_os("BROOD_GC_STRESS").is_some() {
            8192
...
pub(super) fn gc_trace_default() -> bool {
