...
pub use scheduler::{
    ...
    macro_block_active, migrate_count, parent_of, peak_threads, pid_value, self_pid, set_deadline,
    set_max_parallel, set_test_no_workers, spawn, spawn_count, spawn_linked, stack_budget,
