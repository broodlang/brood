...
pub use scheduler::{
    ...
    native_stack_headroom_ok, old_gen_drained, parent_of, peak_threads, pending_kill_phrase,
    pid_value, preempt_count, report_drain_liveness, self_mailbox_seq, self_pid, set_deadline,
